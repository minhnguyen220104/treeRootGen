...
if __name__ == "__main__":
    raw = './Input_ge/Roots/Roots295_merged.out'
    output = './Output_ge/Roots/Roots295.out'
    # raw = './Input_ge/HeteSoil/HeteSoil295_merged.out'
    # output = './Output_ge/HeteSoil/HeteSoil295.out'
